...
function Navbar() {
  ...
  const handleSearchBtn = (e) => {
    e.preventDefault();
    history.push(`/Movies/search?query=${searchText}&page=1`);
  };
  return (
    <>
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link" aria-current="page" to="/Movies/fav">
                  Favorites
                </Link>
              </li>
            </ul>
            ...
            <Link to="/Movies/login" className="btn btn-primary m-1">
              Login
            </Link>
            <Link to="/Movies/register" className="btn btn-success m-1">
              Register
            </Link>
          </div>
        </div>
